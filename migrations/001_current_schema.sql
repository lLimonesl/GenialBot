...
CREATE INDEX IF NOT EXISTS idx_key_events_active_day ON key_events(is_active, day DESC);
CREATE INDEX IF NOT EXISTS idx_characters_status ON characters(status);
CREATE INDEX IF NOT EXISTS idx_narrative_memory_type_day ON narrative_memory(summary_type, day DESC);
